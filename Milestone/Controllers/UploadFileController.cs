...
namespace Milestone.Controllers
{
    public class UploadFileController : Controller
    {
        ...
        [HttpGet("people/all")]
        public ActionResult ListAllPaths()
        {
            return View();
        }
        ...
        [HttpPost]
        public async Task<IActionResult> UploadAsync(SingleFileModel model)
        {
            if (ModelState.IsValid)
            {
                model.IsResponse = true;

                //gets path of where we want to store file
                ...
                {
                    return RunAsync(config, fileNameWithPath, OutputFolderName);
                }
        ...
        /// <returns></returns>
        // <RunAsync>
        private async Task RunAsync(ConfigWrapper config, string mp4name, string OutputFolderName)
        {
